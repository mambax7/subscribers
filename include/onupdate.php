 ...
 */
function xoops_module_pre_update_subscribers(\XoopsModule $module)
{
...
function xoops_module_update_subscribers(\XoopsModule $module, $previousVersion = null)
{
    $moduleDirName = basename(dirname(__DIR__));
    ...
    /** @var Subscribers\Helper $helper */
    /** @var Subscribers\Utility $utility */
    /** @var Subscribers\Configurator $configurator */
    $helper  = Subscribers\Helper::getInstance();
    $utility = new Subscribers\Utility();
    $configurator = new Subscribers\Configurator();

    if ($previousVersion < 240) {

        //rename column EXAMPLE
        $tables     = new Tables();
        $table      = 'subscribersx_categories';
        $column     = 'ordre';
        $newName    = 'order';
