...
//define('_MI_SUBSCRIBERS_HELP_DIR', __DIR__);

//help multi-page
define('_MI_SUBSCRIBERS_DISCLAIMER', 'Disclaimer');
define('_MI_SUBSCRIBERS_LICENSE', 'License');
define('_MI_SUBSCRIBERS_SUPPORT', 'Support');
