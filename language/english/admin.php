...
//1.2
define('_AM_SUBSCRIBERS_UPGRADEFAILED0', "Update failed - couldn't rename field '%s'");
define('_AM_SUBSCRIBERS_UPGRADEFAILED1', "Update failed - couldn't add new fields");
define('_AM_SUBSCRIBERS_UPGRADEFAILED2', "Update failed - couldn't rename table '%s'");
define('_AM_SUBSCRIBERS_ERROR_COLUMN', 'Could not create column in database : %s');
define('_AM_SUBSCRIBERS_ERROR_BAD_XOOPS', 'This module requires XOOPS %s+ (%s installed)');
define('_AM_SUBSCRIBERS_ERROR_BAD_PHP', 'This module requires PHP version %s+ (%s installed)');
define('_AM_SUBSCRIBERS_ERROR_TAG_REMOVAL', 'Could not remove tags from Tag Module');
